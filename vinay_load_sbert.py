...
"""
for name, papram in model.named_parameters():
...
def compute_metrics(eval_pred):
    ...
    acc = np.round(accuracy.compute(predictions=pred_classes, references=labels)['accuracy'],3)
...
#trainer = Trainer(
    ...
    tokenizer=tokenizer,
    data_collator=collate_fn, #data_collator,
